...
@ControllerPath(controllerKey = "/api", viewPath = "/api")
public class WeixinApiController extends ApiController {
	...
	public void createMenu() {
		String str = "{\n" + "    \"button\": [\n" + "        {\n" + "            \"name\": \"系统\",\n"
				+ "            \"url\": \"https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx444833747362271a&redirect_uri=http://uepress.ngrok.cc&response_type=code&scope=snsapi_userinfo&state=wx#wechat_redirect\",\n"
				+ "            \"type\": \"view\"\n" + "        },\n" + "        {\n"
				+ "            \"name\": \"点击事件\",\n" + "            \"key\": \"http://uepress.ngrok.cc/api/createMenu\",\n"
				+ "\t    \"type\": \"click\"\n" + "        },\n" + "        {\n" + "\t    \"name\": \"查看案例\",\n"
				+ "\t    \"url\": \"http://www.ijust4go.com\",\n" + "\t    \"type\": \"view\"\n" + "        }\n"
				+ "    ]\n" + "}";
	...
	public void getUserInfo() {
		ApiResult apiResult = UserApi.getUserInfo("ok8HYwaqClxTulPFV_xwb-Eykayo");
		renderText(apiResult.getJson());
	}
