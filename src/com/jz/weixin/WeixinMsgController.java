 ...
 */
@ControllerPath(controllerKey = "/msg")
public class WeixinMsgController extends MsgControllerAdapter {

	static Log logger = Log.getLog(WeixinMsgController.class);
	// private static final String helpStr = "\t发送 help 可获得帮助，发送\"视频\"
	// 可获取视频教程，发送 \"美女\" 可看美女，发送 music 可听音乐 ，发送新闻可看JFinal新版本消息。公众号功能持续完善中";
	...
	protected void processInLinkMsg(InLinkMsg inLinkMsg) {
		System.err.println("processInLinkMsg:" + inLinkMsg.getUrl());
		// 转发给多客服PC客户端
	...
	protected void processInMenuEvent(InMenuEvent inMenuEvent) {
		...
		System.out.println("processInMenuEvent:" + inMenuEvent.getEventKey());
		//inMenuEvent.setEventKey(inMenuEvent.getEventKey()+"?openid="+inMenuEvent.getFromUserName());
		System.out.println("processInMenuEvent2:" + inMenuEvent.getEventKey());
		String url = SnsAccessTokenApi.getAuthorizeURL(ApiConfigKit.getApiConfig().getAppId(), "http://uepress.ngrok.cc", false);
System.err.println(url);
		//		Constants.setThreadLocalConfig("openid", inMenuEvent.getFromUserName());
//		setSessionAttr("getEventKey", inMenuEvent.getEventKey());
